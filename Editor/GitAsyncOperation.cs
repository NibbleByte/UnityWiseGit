...
namespace DevLocker.VersionControl.WiseGit
{
	...
	/// </summary>
	public class GitAsyncOperation<TResult> : IShellMonitor
	{
		public delegate TResult OperationHandler(GitAsyncOperation<TResult> operation);
		public delegate void OperationCompleteHandler(GitAsyncOperation<TResult> operation);
		...
		/// </summary>
		public static GitAsyncOperation<TResult> Start(OperationHandler operationHandler)
		{
			var op = new GitAsyncOperation<TResult>(operationHandler);
			op.Start();
			return op;
		}
