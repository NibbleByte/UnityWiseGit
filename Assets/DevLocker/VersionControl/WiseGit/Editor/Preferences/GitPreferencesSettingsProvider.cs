...
namespace DevLocker.VersionControl.WiseGit.Preferences
{
	...
	internal class WiseGitProjectPreferencesSettingsProvider : SettingsProvider
	{
		...
		{
			var provider = new WiseGitProjectPreferencesSettingsProvider("Preferences/" + m_SettingsProviderName, SettingsScope.User);
		...
		{
			var provider = new WiseGitProjectPreferencesSettingsProvider("Project/" + m_SettingsProviderName, SettingsScope.Project);
			provider.keywords = m_Keywords;
		...
		public override void OnGUI(string searchContext)
		{
			...
			GitPreferencesWindow.DrawHelpAbout();
		}
	}
#endif
